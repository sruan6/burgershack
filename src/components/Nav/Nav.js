			...
			<Router>
				<div>
					<nav className="navbar navbar-expand-lg navbar-light">
					  ...
					  <button onClick={this.handleOpen} type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
